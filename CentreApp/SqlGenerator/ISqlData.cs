...
namespace SqlData.SqlGenerator
{
    ...
    {   
        ...
        Task<IEnumerable<T>> SqlQueryAsync<T>(string query, object parameters = null);
         ...
         Task<int> SqlExecuteProcAsync(string query, object parameters = null);

        int SqlExecuteProc(string query, object parameters = null);
         IEnumerable<T> SqlQueryProc<T>(string query, object parameters = null);
        Task<IEnumerable<T>> SqlQueryProcAsync<T>(string qry, object parameters = null);
        // Sql query
